...
const targetDate = ['2022-10-13','2022-10-14','2022-10-15','2022-10-16','2022-10-17'];
let errorCount = 0;
...
async function setDate() {
    for(let i = 0; i < targetDate.length; i++) {
        ...
        const m = await setOrderChannel(startDateArray, endDateArray);
        console.log(targetDate[i], m);
